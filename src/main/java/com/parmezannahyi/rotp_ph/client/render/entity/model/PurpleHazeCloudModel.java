...
public class PurpleHazeCloudModel extends EntityModel<PurpleHazeCloudEntity> {
    private final ModelRenderer bb_main;

    public PurpleHazeCloudModel() {
    ...
    @Override
    public void setupAnim(PurpleHazeCloudEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float yRotationOffset, float xRotation){
